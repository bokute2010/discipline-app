...
type IImageInputOnchange = (value: ImageInputFilesType, addUpdatedIndex?: number[]) => void;

interface IImageInputProps {
  value: ImageInputFilesType;
  onChange: IImageInputOnchange;
...
export {
  ...
  type ImageInputFilesType,
  type IImageInputFile,
  type IImageInputOnchange
};
